...
export const DocumentListPage = () => {
    ...
    const { documents, loading } = useAppSelector((state: RootState) => state.document);
    ...
    console.log("DocumentCard", documents)
    ...
    return (
        <div className="p-6">
            ...
            {showCreateModal && <Modal title="Create Document" isOpen={showCreateModal} onClose={() => setShowCreateModal(false)}>
